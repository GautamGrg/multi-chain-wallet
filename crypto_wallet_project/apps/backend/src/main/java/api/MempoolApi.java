...
public class MempoolApi {
    ...
    public static Boolean getIsValid(String address) throws IOException, InterruptedException{
        HttpRequest getIsValid = HttpRequest.newBuilder().uri(URI.create("https://mempool.space/testnet/api/v1/validate-address/"+address)).GET().build();
    ...
    public static String getUtxo(String address) throws IOException, InterruptedException{
        HttpRequest getUtxo = HttpRequest.newBuilder().uri(URI.create("https://mempool.space/testnet/api/address/"+address+"/utxo")).GET().build();
    ...
    public static String postTrans(Hex transactionId) throws IOException, InterruptedException{
        HttpRequest postTrans = HttpRequest.newBuilder().uri(URI.create(""+"https://mempool.space/testnet/api/tx")).build();
